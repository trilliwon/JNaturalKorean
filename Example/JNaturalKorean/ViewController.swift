...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    testTextView.text.appendContentsOf("\("010-0000-7330".이_가) 전 여친 전화번호 입니다..\n")
    testTextView.text.appendContentsOf("\("그 여자".이_가) 전 여친 입니다.\n")
    
    testTextView.text.appendContentsOf("\n목적격조사\n\n")
    testTextView.text.appendContentsOf("\("3개의 문장".을_를) 외워야 합니다.\n")
    testTextView.text.appendContentsOf("\("010-0000-7332".을_를) 해킹.\n")
    ...
    testTextView.text.appendContentsOf("\("010-0000-7335".은_는) 내 전화번호 입니다..\n")
    
    testTextView.text.appendContentsOf("\n호격조사\n\n")
    testTextView.text.appendContentsOf("\("이 세상".아_야)!\n")
    testTextView.text.appendContentsOf("\("이 세상".아_야)!\n")
    testTextView.text.appendContentsOf("\("010-0000-7336".아_야)!\n\n\n")
    
    testTextView.text.appendContentsOf("\("그 여자".와_과) 함께\n")
    testTextView.text.appendContentsOf("\("그 사람".와_과) 함께\n\n")
    testTextView.text.appendContentsOf("\("010-0000-7338".와_과) 내 번호는 비슷함.\n\n\n")

    testTextView.text.appendContentsOf("\("010-0000-7333".으로_로) 인증번호가 발송됩니다.\n\n\n")
